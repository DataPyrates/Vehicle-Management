...
$cust_book ='select * from vsms_customer_booking order by id desc ';
$statement = $db->prepare($cust_book);
$statement->execute(); 
$cust_book_data = $statement->fetch();
$invoice_no = $cust_book_data['invoice_no']+1;
...
if($i == $count){
$msg="Customer Booking has been added.";
}
}
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card-box">
                    ...
                    <h4 class="m-t-0 header-title">Add Customer Booking</h4>
                            ...
                            <div class="p-20">
                                ...
                                <form class="form-horizontal" role="form" method="post" name="submit">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <a href="add-customer.php" target="_blank"><i class="icon-plus" title="Add Customer"></i></a></label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <a href="add-vehicle.php" target="_blank"><i class="icon-plus" title="Add Vehicle"></i></a></label>
                                        <div class="col-10">
                                   ...
                                   <!--  <div class="form-group row">
                                        <label class="col-2 col-form-label" for="example-email">Reference</label>
                                        <div class="col-10">
                                            <input type="text" id="reference" name="reference" class="form-control" disabled="">
                                        </div>
                                    </div> -->
...
<!-- 
                                    <div class="form-group row">
                                        <label class="col-2 col-form-label" for="example-email">Customer Order Number</label>
                                        <div class="col-10">
                                            <input type="text"  name="customer_order_number" class="form-control"  required="true">
                                        </div>
                                    </div> -->
                                  ...
                                  <b>Customer Invoice</b>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-4">
                                            <input type="text"  name="job_card_no" class="form-control" value="<?php echo $invoice_no; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                       <!--  <label class="col-2 col-form-label" for="example-email">Order Number</label>
                                        <div class="col-4">
                                            <input type="text"  name="order_number" class="form-control"  required="true">
                                        </div> -->
...
var cust_id = '<?php echo $_REQUEST["cust_id"]; ?>';
if(cust_id){
...
console.log(data,details.mobile);
