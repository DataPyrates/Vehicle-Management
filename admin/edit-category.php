...
if(isset($_POST['submit']))

  {
    ...
    $msg="Drive Type has been update.";
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="card-box">
                                    ...
                                    <h4 class="m-t-0 header-title">Update Drive Type</h4>
    ...
    echo $msg;
                                               ...
                                               <form class="form-horizontal" role="form" method="post" name="submit">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <label class="col-2 col-form-label" for="example-email">Drive Type Name</label>

                                                        <div class="col-10">

                                                            <input type="text" id="catename" name="catename" class="form-control" placeholder="Drive Type" required="true"  value="<?php echo $row['VehicleCat'];?>">
