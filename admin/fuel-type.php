            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="card-box">
                        ...
                        <h4 class="m-t-0 header-title">Fuel Type Dashboard</h4>
...
$(document).on('click', '.delete', function(){
  var id = $(this).attr("id");
  if(confirm("Are you sure you want to delete the Fuel Type?"))
  {
   $.ajax({
    url:"model/generic_delete.php",
    method:"POST",
    data:{id:id,table:'vsms_fuel_type'},
