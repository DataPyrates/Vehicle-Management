            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="card-box">
                        ...
                        <h4 class="m-t-0 header-title">Job Status Dashboard</h4>
...
var dataTable = $('#street_data').DataTable({
  ...
  "order":[],
  "ajax":{
   url:"model/job_status_fetch.php",
   type:"POST"
  },
  "columnDefs":[
   {
...
$(document).on('click', '.delete', function(){
  var id = $(this).attr("id");
  if(confirm("Are you sure you want to delete the Job Status?"))
  {
   $.ajax({
    url:"model/generic_delete.php",
    method:"POST",
    data:{id:id,table:'vsms_job_status'},
