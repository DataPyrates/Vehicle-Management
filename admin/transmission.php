            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="card-box">
                        ...
                        <h4 class="m-t-0 header-title">Transmission Dashboard</h4>
...
var dataTable = $('#street_data').DataTable({
  ...
  "order":[],
  "ajax":{
   url:"model/transmission_fetch.php",
   type:"POST"
  },
  "columnDefs":[
   {
...
$(document).on('click', '.delete', function(){
  var id = $(this).attr("id");
  if(confirm("Are you sure you want to delete the Transmission?"))
  {
   $.ajax({
    url:"model/generic_delete.php",
    method:"POST",
    data:{id:id,table:'vsms_transmission'},
    success:function(data)
    {
     alert(data);
